...
final class PyTupleIter extends PyIter {
    private static final PyConcreteType type_singleton = new PyConcreteType("tuple_iterator", "tuple_iterator", "builtins", PyTupleIter.class, PyObjectType.singleton, null);
