...
final class PyBytesIter extends PyIter {
    private static final PyConcreteType type_singleton = new PyConcreteType("bytes_iterator", "bytes_iterator", "builtins", PyBytesIter.class, PyObjectType.singleton, null);
